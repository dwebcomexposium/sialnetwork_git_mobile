/**!
	Module table split or overflow

	@contributors: Guillaume Focheux (Alsacréations), changed by RR
...
;(function($) {
    ...
    */
    ...
    // Tables generated by wysiwyg
    $('.article-content table').each(function(){
        /*var tableArray = extractAllColumns( $(this) );
        makeNewTable(tableArray, $(this));
        $(this).hide();*/
        $(this).wrap('<div class="mobile-table-overflow-scroll"></div>');
    });
